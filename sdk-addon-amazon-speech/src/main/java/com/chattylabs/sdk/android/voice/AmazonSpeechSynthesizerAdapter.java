...
abstract class AmazonSpeechSynthesizerAdapter implements SynthesizerUtteranceListener {
    ...
    @Override
    public AmazonSpeechSynthesizerAdapter _setOnStartedListener(SynthesizerListener.OnStart onStartedListener) {
    ...
    @Override
    public AmazonSpeechSynthesizerAdapter _setOnDoneListener(SynthesizerListener.OnDone onDoneListener) {
    ...
    @Override
    public AmazonSpeechSynthesizerAdapter _setOnErrorListener(SynthesizerListener.OnError onErrorListener) {
